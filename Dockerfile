...
RUN R -q -e 'install.packages("BiocManager"); BiocManager::install(c("devtools")); BiocManager::install(c("lifecycle", "gtools", "optparse","RColorBrewer","ggplot2","gridExtra","readr","doParallel","foreach", "splines"), lib="/opt/R-libs")'
